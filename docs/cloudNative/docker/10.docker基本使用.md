...
```bash
$ docker run -v /Users/qiqiang/Desktop/docker-supershop/redis/redis.conf:/usr/local/conf/redis/redis.conf -p 6379:6379 --rm --name redis5pass redis:5  redis-server /usr/local/conf/redis/redis.conf
```
...
```bash
$ docker run --name qqnginx-fileServer --rm -p 7070:7070 -v /Users/qiqiang/Desktop/docker-supershop/nginx/nginx-file.conf:/conf/nginx/nginx.conf -v /Users/qiqiang/Desktop/docker-supershop/nginx/fileStore:/home/fileStore nginx
```
...
```bash
$ docker run --name dfnxingv1 --rm -p 7070:7070 -v /Users/qiqiang/Desktop/docker-supershop/nginx/nginx-file.conf:/conf/nginx/nginx.conf -v /Users/qiqiang/Desktop/docker-supershop/nginx/fileStore:/home/fileStore dfnginx:v1
```
